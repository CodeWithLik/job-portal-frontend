...
const rebuiltCode = `import { useState, useEffect, useRef } from 'react';
...
fs.writeFileSync(registerPath, rebuiltCode);
console.log("Completely rebuilt Register.jsx safely.");
